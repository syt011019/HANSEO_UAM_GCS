...
private:
    ...
    void callback_local_velocity(const geometry_msgs::TwistStamped::ConstPtr& msg);
    void callback_body_velocity(const geometry_msgs::TwistStamped::ConstPtr& msg);
    ...
    void callback_local_position_target(const mavros_msgs::PositionTarget::ConstPtr& msg);
...
public:
    ...
    void set_velocity_ned(float Vn, float Ve, float Vd, float yaw_rate);
public:    
...
public:
    ...
    uint8_t topic_check(std::string name);    
};
