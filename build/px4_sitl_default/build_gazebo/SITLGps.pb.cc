...
void SITLGps::SerializeWithCachedSizes(
  ...
  if (has_time_utc_usec()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt64(2, this->time_utc_usec(), output);
  }
...
::google::protobuf::uint8* SITLGps::InternalSerializeWithCachedSizesToArray(
  ...
  // optional int64 time_utc_usec = 2;
  if (has_time_utc_usec()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt64ToArray(2, this->time_utc_usec(), target);
  }
...
void SITLGps::clear_time_utc_usec() {
 ...
 ::google::protobuf::int64 SITLGps::time_utc_usec() const {
  // @@protoc_insertion_point(field_get:sensor_msgs.msgs.SITLGps.time_utc_usec)
  return time_utc_usec_;
}
 void SITLGps::set_time_utc_usec(::google::protobuf::int64 value) {
  set_has_time_utc_usec();
